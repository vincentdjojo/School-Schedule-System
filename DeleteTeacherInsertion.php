...
<center>
	You are attempting to delete a teacher<br>
	Doing this will cause the previous time table to be deleted
</font>
</center>
<br>
<table>
<tr>
	<td>
		<a href="DeleteTeacherInsertion2.php?tid=<?php print $_GET['tid']?>&fn=<?php print $_GET['fn']?>&ln=<?php print $_GET['ln']?>"><button type="button" style="height:50px; width:100px">Proceed</button></a>
	</td>
</tr>
<tr>
	<td>
		<a href="TeacherInsertion.php"><button type="button" style="height:50px; width:100px">Cancel</button></a>
	</td>
</tr>
</tr></td>
</table>
