...
<body>
 ...
 content="text/html; charset=ISO-8859-1">
  <title>Choose a Period Time and Day for Physical Education</title>
</head>
<body>
	<ul>	
 		<li2>
...
<tr>
	<td>
	<center>
		<h2>Choose a Period Time and Day for Physical Education</h2>	
...
<tr>
	<td>
		...
		<input type="hidden" name="PrioritySubject" value="PHE">
	</td>
	<?php 
	 ...
	 ?>
		...
		<td><a href="PrioritySubjectMenu.php"><button type="button">Return</button></a></td>
	<?php 
		//} 
	?>
</tr>
