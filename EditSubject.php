...
<tr>
	<td>
		<a href="EditSubject2.php?sid=<?php print $_GET['sid']?>&sn=<?php print $_GET['sn']?>&c=<?php print $_GET['c']?>"><button type="button" style="height:50px; width:100px">Proceed</button></a>
	</td>
</tr>
<tr>
	<td>
