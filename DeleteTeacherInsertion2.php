<?php
		...
		$DeleteTeacher= "DELETE from teacher WHERE TeacherID='$TeacherID' AND FirstName='$FirstName' AND LastName='$LastName'";
			$DeleteTeacherResult=mysql_query($DeleteTeacher); 
		echo $DeleteTeacher;
?>
...
<tr>
	<td>
		<a href="TeacherInsertion.php"><button type="button" style="height:50px; width:100px">Done</button></a>
	</td>
</tr>
