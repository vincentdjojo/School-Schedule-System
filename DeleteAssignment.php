...
<center>
	You are attempting to delete an assignment<br>
...
<tr>
	<td>
		<a href="DeleteAssignment2.php?tid=<?php print $_GET['tid']?>&sid=<?php print $_GET['sid']?>&cid=<?php print $_GET['cid']?>&periods=<?php print $_GET['periods']?>"><button type="button" style="height:50px; width:100px">Proceed</button></a>
	</td>
</tr>
<tr>
	<td>
