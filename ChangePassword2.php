<?php
		...
		if($PasswordError=="") {
			if($PasswordCheckError=="") {
				$InsertionCheck='Password successfully changed';
				$SQL = "UPDATE admin
															...
															<tr>
																<td align='center'>
																	<table>
																		...
																		<tr>
																			<td colspan="2">
																			  <font color='green' size='0.1'><?php echo $InsertionCheck;?></font><font color='red' size='0.1'><?php echo $PasswordError; ?></font>
																			</td>
																		</tr>
																		<tr>
																			<td>
