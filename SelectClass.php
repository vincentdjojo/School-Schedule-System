...
<table style="width: 100%; height: 516px; text-align: left; margin-left: auto; margin-right: auto;" background="tablebackground.png" border="1" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td>
			<table style="width:25%; height:516px;" background="backgroundforcontact.png" border="0" cellpadding="0" align='center'>
				<tr>
					<td align='center'>
					<img src="selectclass.png"><img src="baka2.png" alt="" width="162" height="224">
	...
	<form action="CheckPrioritySubjects.php" method="post">
		<center>
			<table style="height: 20px;" align="center" bgcolor="">	
				<tr>
					<td>Class:</td><td><select name='ClassID'>
				<?php
...
<?php				
			...
			<tr><td><input type="submit" value="Submit"></td><td><a href="ScheduleGeneration.php"><button type="button">Return</button></a></td></tr>
			</table>
		</center>
	</form>
													</td>
