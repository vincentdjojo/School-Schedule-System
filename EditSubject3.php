...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
		...
		echo $SubjectID;
		$PreviousSubjectID=$_POST["sid"];
		$PreviousSubjectName=$_POST['sn'];
		$PreviousCategory=$_POST['c'];		
		...
		if ($SubjectNameError == "") {
			...
			if($db_found) {
				...
				$SQL = "SELECT * FROM subject WHERE SubjectID = '$SubjectID'";
						...
						$SQL = "UPDATE subject SET SubjectID= UPPER('$SubjectID'),SubjectName='$SubjectName',Category='$Category'
                 		                     WHERE SubjectID='$PreviousSubjectID' AND SubjectName='$PreviousSubjectName' AND Category='$PreviousCategory'";
