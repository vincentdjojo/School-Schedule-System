<?php
      ...
      $num_rows = mysql_num_rows($result);  		   	
   	...
   	$SQLGetAss = "SELECT * FROM periodassignment WHERE SubjectID='ASS'";
   		$GetAssResult = mysql_query($SQLGetAss);
   	
   	while($db_field=mysql_fetch_assoc($GetAssResult)) {
   		$Ass=$db_field['SubjectID'];
   		$time=$db_field['PeriodTime'];
   		$day=$db_field['PeriodDay'];
   	}

		$SQLwrite = "INSERT INTO periodassignment (TeacherID,SubjectID,ClassID,PeriodTime,PeriodDay)
      	VALUES ('ALL','$Ass','$ClassID','$time','$day')";        
      	$result = mysql_query($SQLwrite);
      	
   	$SQLGetCpl = "SELECT * FROM periodassignment WHERE SubjectID='CPL'";
   		$GetCplResult = mysql_query($SQLGetCpl);
      	
   	while($db_field=mysql_fetch_assoc($GetCplResult)) {
		...
		$SQLwrite = "INSERT INTO periodassignment (TeacherID,SubjectID,ClassID,PeriodTime,PeriodDay)
      	VALUES ('ALL','$Cpl','$ClassID','$time','$day')";        
      	$result = mysql_query($SQLwrite);   	   	
   	}
?>	
<html>
...
<form action="ParallelSubjectAssign2.php" method="post">
	<center>
...
<?php				
		...
		<tr>
			...
			<td><a href="selectclassparallelsubject.php"><button type="button">Return</button></a></td>
													</td>
												</tr>
											</table>
