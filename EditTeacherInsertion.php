...
<tr>
	<td>
		<a href="EditTeacherInsertion2.php?tid=<?php print $_GET['tid']?>&fn=<?php print $_GET['fn']?>&ln=<?php print $_GET['ln']?>"><button type="button" style="height:50px; width:100px">Proceed</button></a>
	</td>
</tr>
<tr>
	<td>
