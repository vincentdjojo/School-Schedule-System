											...
											<td align='center'>									
												...
												<table background="backgroundforcontact4.png "style="background-size: 100% 100%; font-size:90%;";>
															<tr>
																<td align='center'>
																	<font size='0.5'>
																		<a href="ChangePassword.php"><button type="button" style="height:35px;width:100px"><font size='0.5'>Change Password</font></button></a><br><br>	
																		<?php 
																			$GetPrivlege = "SELECT * FROM admin WHERE TeacherID='$TeacherID'";
   																			$GetPrivlegeResult = mysql_query($GetPrivlege);
   																		while ($row = mysql_fetch_assoc($GetPrivlegeResult)) {
   																			$HeadTest=$row['Head'];
   																		}
   																		if($HeadTest==1) {																		
																		?>																		
																		<a href="AddAdmin.php"><button type="button" style="height:35px;width:100px"><font size='0.5'>Add a Moderator</font></button></a><br><br>
																		<a href="RemoveAdmin.php"><button type="button" style="height:35px;width:100px"><font size='0.5'>Remove a Moderator</font></button></a><br><br>
																		<?php 
																			}																		
																		?>																		
																		<a href="login3.php"><button type="button"><font size='0.5'>Return</font></button></a>	
																	</font>		
																</td>
																</tr>
														</table>
