...
<tr>
	<td>
		<a href="EditClass2.php?cid=<?php print $_GET['cid']?>&cn=<?php print $_GET['cn']?>"><button type="button" style="height:50px; width:100px">Proceed</button></a>
	</td>
</tr>
<tr>
	<td>
		<a href="ClassInsertion.php"><button type="button" style="height:50px; width:100px">Cancel</button></a>
	</td>
</tr>
</tr></td>
</table>
