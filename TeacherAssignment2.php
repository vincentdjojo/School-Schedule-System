<html>
	...
	<?php
		...
		//$TeacherIDError= $SubjectIDError= $ClassIDError= "";
				...
				$SQL = "SELECT * FROM assignment WHERE TeacherID = '$TeacherID' AND SubjectID = '$SubjectID' AND ClassID = '$ClassID'";
   				...
   				if($SubjectIDError=="") {  
   					$InsertionCheck="Assignment Successful";      
						$SQLwrite = "INSERT INTO assignment (TeacherID,SubjectID,ClassID,Periods)
                                        VALUES ('$TeacherID','$SubjectID','$ClassID','$Periods')";        
